...
from YWasteFood import settings
from . forms import *
...
def donateFood(request):
    if request.method == 'POST':
        ...
        subject = "Food Donation Requsted - YWasteFood"
...
def donateCloth(request):
    if request.method == 'POST':
        ...
        subject = "Cloth Donation Requsted - YWasteFood"
        message = "Hello " + donor.first_name + "!! \n" + \
...
def volunteerFoodDonationAssignment(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Accept':
            ...
            # Email to Donor
            subject = "Food Donation Will Be Picked ASAP - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
            ...
            # Email to volunteer
            subject = "Food Donation Assigned to Pick Up - YWasteFood"
...
def volunteerClothDonationAssignment(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Accept':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Cloth Donation Will Be Picked ASAP - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
            ...
            # Email to volunteer
            subject = "Cloth Donation Assigned to Pick Up - YWasteFood"
            message = "Hello " + volunteerUser.first_name + "!! \n" + \
...
def volunteerFoodDonationPickUpConfirmation(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Picked':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Food Donation Has Been Picked Up - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
            ...
            # Email to volunteer
            subject = "Food Donation Picked Up - YWasteFood"
            message = "Hello " + volunteerUser.first_name + "!! \n" + \
...
def volunteerClothDonationPickUpConfirmation(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Picked':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Cloth Donation Has Been Picked Up - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
...
def volunteerClothDonationDeliveryConfirmation(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Delivered':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Cloth Donation Delivered to Distribution Team - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
...
def donCoFoodDonationReceivedConfirmation(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Decline':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Food Donation Has Been Declined - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
            ...
            # Email to volunteer
            subject = "Food Donation Received - YWasteFood"
            message = "Hello " + volunteerUser.first_name + "!! \n" + \
                "Respectable Volunteer, You have delivered a food donation.\n\n\n\nDetails:\n"+"Food Donation For: " + \
                str(mydonation.quantity)+"\nDescription: "+mydonation.description+"\nDonor Name: "+donor.first_name + \
                "\nDonor Phone: "+donor.profile.phone+"\nDonor Address: " + \
...
def donCoClothDonationReceivedConfirmation(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Decline':
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
            subject = "Cloth Donation Declined - YWasteFood"
            message = "Hello " + donor.first_name + "!! \n" + \
            ...
            # Email to volunteer
            subject = "Cloth Donation Declined to Distribution Team - YWasteFood"
            message = "Hello " + volunteerUser.first_name + "!! \n" + \
...
def moneyDonationVerification(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Verify':
            ...
            subject = "Money Donation Verified - YWasteFood"
            ...
            subject = "Money Donation Could Not Be Verified - YWasteFood"
            message = "Hello " + donorUser.first_name + "!! \n" + \
...
def foodDonationVerification(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get("status") == 'Verify':
            ...
            subject = "Food Donation Verified - YWasteFood"
            message = "Hello " + donorUser.first_name + "!! \n" + \
...
def foodInventoryFunc(request, pk):
    ...
    if request.method == 'POST':
        ...
        mydonation.save()
            ...
            # volunteer = User.objects.get(username=donorUser[0])
            # Email to Donor
        subject = "Food Donation Has Been Received - YWasteFood"
        message = "Hello " + donor.first_name + "!! \n" + \
